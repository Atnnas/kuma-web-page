            ...
            <div className="">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                        <div>
                            <h1 className="text-3xl font-serif font-black uppercase tracking-widest mb-2 text-kuma-gold drop-shadow-md">
                                Gestión de <span className="text-red-600 drop-shadow-[0_0_15px_rgba(220,38,38,0.4)]">Usuarios</span>
                            </h1>
                            <p className="text-zinc-400 font-medium">Administra roles y accesos de los miembros del Dojo.</p>
                        </div>
                    </div>
                                    ...
                                    <table className="w-full text-left border-collapse">
                                        <thead>
                                            <tr className="border-b border-zinc-800 bg-zinc-900/80">
                                                <th className="p-4 text-xs font-bold text-zinc-500 uppercase tracking-widest">Usuario</th>
                                                <th className="p-4 text-xs font-bold text-zinc-500 uppercase tracking-widest hidden md:table-cell">Email</th>
                                                <th className="p-4 text-xs font-bold text-zinc-500 uppercase tracking-widest text-center">Estado</th>
                                                <th className="p-4 text-xs font-bold text-zinc-500 uppercase tracking-widest text-center">Rol</th>
                                                    ...
                                                    <td className="p-4">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-zinc-500 text-xs md:hidden">{user.email}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className="p-4 text-zinc-400 text-sm hidden md:table-cell">{user.email}</td>
