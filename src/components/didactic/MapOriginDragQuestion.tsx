...
export function MapOriginDragQuestion({
    ...
    return (
        <div className="w-full space-y-3 select-none">
            ...
            {/* HEADER INTERACTIVO PARA NIÑOS: INSTRUCCIÓN MÍNIMA + BOTÓN DE VOZ DE KUMA */}
            <div className="flex flex-wrap items-center justify-between gap-2 p-2.5 sm:p-3 rounded-2xl bg-[#0F1D2B]/95 border-2 border-[#1CB0F6]/40 shadow-lg">
                <div className="flex items-center gap-2 min-w-0">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-amber-500 to-yellow-400 text-slate-950 flex items-center justify-center font-black text-lg shrink-0 shadow-md">
                        ⛵
                    </div>
                    <div className="min-w-0">
                        <span className="text-[10px] font-black uppercase tracking-wider text-amber-300 flex items-center gap-1">
                            <Compass className="w-3.5 h-3.5" weight="fill" />
                            <span>La Ruta del Barquito de Kuma</span>
                        </span>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                    ...
                    <button
                        ...
                        title={isVoiceActive ? "Voz de Kuma activa (toca para silenciar)" : "Activar voz de Kuma"}
                    >
                        {isVoiceActive ? (
                            <>
